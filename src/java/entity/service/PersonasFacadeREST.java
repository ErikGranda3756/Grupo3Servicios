 ...
 */
@javax.ejb.Stateless
@Path("entity.personas")
public class PersonasFacadeREST extends AbstractFacade<Personas> {

    @PersistenceContext(unitName = "grupo3PU")
    private EntityManager em;

    public PersonasFacadeREST() {
        super(Personas.class);
        this.em = Persistence.createEntityManagerFactory("grupo3PU").createEntityManager();
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Personas entity) {
        super.edit(entity);
    }
